...
void main() {
  ...
  setUp(() {
    ...
    getProfileUseCase = GetProfileUseCase(profileRepo: mockProfileRepo);
  });

  group('GetProfileUseCase', () {
    test(
      'should return success response when repository gets profile successfully',
      () async {
        // Arrange
        when(
    ...
    test(
      'should return error response when repository fails to get profile',
      () async {
        // Arrange
