...
void main() {
  ...
  setUp(() {
    ...
    verifyResetCodeUseCase = VerifyResetCodeUseCase(mockForgotPasswordRepo);
  });
  ...
  group('VerifyResetCodeUseCase', () {
    test(
      ...
      () async {
        // Arrange
        const entity = VerifyResetCodeEntity(resetCode: '123456');

        when(
          mockForgotPasswordRepo.verifyResetCode(
