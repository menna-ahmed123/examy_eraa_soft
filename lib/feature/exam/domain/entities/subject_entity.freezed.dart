...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SubjectEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.icon, icon) || other.icon == icon));
}
...
/// Adds pattern-matching-related methods to [SubjectEntity].
extension SubjectEntityPatterns on SubjectEntity {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SubjectEntity value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _SubjectEntity() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SubjectEntity value)  $default,){
final _that = this;
switch (_that) {
case _SubjectEntity():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SubjectEntity value)?  $default,){
final _that = this;
switch (_that) {
case _SubjectEntity() when $default != null:
return $default(_that);case _:
...
class _SubjectEntity implements SubjectEntity {
  const _SubjectEntity({required this.id, required this.name, required this.icon});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SubjectEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.icon, icon) || other.icon == icon));
}
