...
mixin _$AuthResponseEntity {
 ...
 String get message; String get token; UserEntity get user;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthResponseEntity&&(identical(other.message, message) || other.message == message)&&(identical(other.token, token) || other.token == token)&&(identical(other.user, user) || other.user == user));
}
...
@override
String toString() {
  return 'AuthResponseEntity(message: $message, token: $token, user: $user)';
}
...
@useResult
$Res call({
 String message, String token, UserEntity user
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String message,  String token,  UserEntity user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthResponseEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String message,  String token,  UserEntity user)  $default,) {final _that = this;
switch (_that) {
case _AuthResponseEntity():
return $default(_that.message,_that.token,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String message,  String token,  UserEntity user)?  $default,) {final _that = this;
switch (_that) {
case _AuthResponseEntity() when $default != null:
return $default(_that.message,_that.token,_that.user);case _:
  return null;
...
class _AuthResponseEntity implements AuthResponseEntity {
  const _AuthResponseEntity({required this.message, required this.token, required this.user});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthResponseEntity&&(identical(other.message, message) || other.message == message)&&(identical(other.token, token) || other.token == token)&&(identical(other.user, user) || other.user == user));
}
